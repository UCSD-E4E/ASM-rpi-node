...
# # Test codec on a .bin file:
# with open("Arduino_Data.bin", mode="rb") as file:
#     binaryData = file.read()

# print("binaryData")
# print(type(binaryData))
# print(len(binaryData))
# print(type(binaryData[0]))
# print("\n")

# # Create instance of codec class
# codec = Codec()

# # Test decode:
# binaryPackets = codec.decode(binaryData)
# print("binaryPackets")
# print(type(binaryPackets))
# print(len(binaryPackets))
# print(type(binaryPackets[0]))
# print("\n")

# # Test encode:
# binaryBytes = codec.encode(binaryPackets)
# print("binaryBytes")
# print(type(binaryBytes))
# print(len(binaryBytes))
# print(type(binaryBytes[0]))
# print("\n")

# # Write encoded bytes objects to bin:
# f = open("binaryBytes.bin", "wb")
# f.write(binaryBytes)
# f.close()