    ...
    while(True):
        ...
        with open(csvname,'w') as csvFile:
            while time.time() < t_end:
                ...
                #if len(packets) = 2: 
                #    arduinoliveGUI.notworking(gui)
                #    print("Possible Arduino Error")
                ...
                #timestamppost = dt.datetime.now() 
                #if (timestamppost - timestamp > 7): 
                #    arduinoliveGUI.notworking(gui)
                #    print("Possible Arduino Error")
...
if __name__ == '__main__':
 ...
 #       try:
        ...
        #return 1 #meaning the sensor is working
#        except:
#            pass
            #return -1 #idk if this breaks this script or not?
            #print(packets)
            #add a timeout? 
            #or add a variable/flag for diplay.py? 
        #except:
            #x=68
            #pass
#    except:
