...
import serial
import time
#import arduinoliveGUIv3 # imports arduinoliveGUIv3.py as a module
#from  arduinoliveGUIv3 import Window # imports the Window class
#import OB_classesv3
#from OB_classesv3 import On_Box_Window
#from mail_alertv2 import MailAlert
#from mail_alertv2 import *
...
#def bestfunction():
  ...
  #          gui.start()
            ...
            #    refresh_token, access_token, expires_in = get_authorization(GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET) 
             #   print('Set refresh toke:', refresh_token)
             #   exit() 
